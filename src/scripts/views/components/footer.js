const footer = {
  init() {
    return `
		<div id="footer" class="flex justify-around grid-cols-2 w-full h-auto md:h-[400px] p-12 bg-white">
			<div>
			...
			<div>
				<div class="grid grid-rows-2 md:grid-rows-2">
					<h5 class="text-base md:text-lg font-bold my-4">Media Sosial</h5>
					...
					<div>
						<span class="m-auto font-text text-sm font-bold">Copyright ©2022. Designer By <span class="text-red-600">PT.Restu Agung Narogong</span></span>
					</div>
				</div>
			</div>
