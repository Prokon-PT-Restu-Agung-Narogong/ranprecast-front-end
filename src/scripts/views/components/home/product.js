		...
		<div id="product" class="w-full bg-black py-4 md:p-12">
			...
			<div class="flex w-5/6 mx-auto md:h-[350px] mt-4 xl:h-[831px]">
				<ul id="product" class="w-full h-full grid grid-cols-1  grid-rows-3 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-2 gap-4">
					<li class="w-full md:w-full card card-product-1 ml-auto flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[0].img[0]}')">
					...
					<li class="w-full md:w-full card card-product-2 flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[1].img[0]}')">
						<div class="mt-auto w-full p-8 desc-card">
					...
					<li class="w-full md:w-full card card-product-3 mr-auto flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[2].img[0]}')">
						<div class="mt-auto w-full p-8 desc-card">
					...
					<li class="w-full md:w-full card card-product-4 mr-auto flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[3].img[0]}')">
						<div class="mt-auto w-full p-8 desc-card">
					...
					<li class="w-full md:w-full card card-product-5 mr-auto flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[4].img[0]}')">
						<div class="mt-auto w-full p-8 desc-card">
					...
					<li class="w-full md:w-full card card-product-6 mr-auto flex bg-no-repeat bg-center bg-cover lazyload" src="./images/loading.gif" style="background-image : url('${dataProducts[5].img[0]}')">
						<div class="mt-auto w-full p-8 desc-card">
